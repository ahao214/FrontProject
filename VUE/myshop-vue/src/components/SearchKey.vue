...
<template>
    <div class="search-body">
        <el-autocomplete v-model="searchText" style="width:100%;" class="media-search inline-input" size="large" :fetch-suggestions="querySearch" :trigger-on-focus="false" placeholder="请输入想要的商品" :suffix-icon="Search" @select="handleSelect" select-when-unmatched clearable>
